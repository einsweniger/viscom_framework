...
namespace minuseins::handlers {
    struct SceneSubroutineHandler : SubroutineUniformHandler {
        SceneSubroutineHandler(gl::GLenum stage, viscom::ApplicationNodeImplementation *appImpl);
    ...
    struct SubroutineChanger : SubroutineUniform {
        SubroutineChanger(gl::GLenum stage, const named_resource &res, viscom::ApplicationNodeImplementation *appImpl);
