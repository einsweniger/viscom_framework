...
property_map
GetProgramResourceiv(const gl::GLuint program, const interface_type interface, const gl::GLuint index, const std::vector<gl::GLenum> &props) {
  ...
  glGetProgramResourceiv(program, static_cast<gl::GLenum>(interface), index, propCount, &props[0], bufSize, &length, &params[0]);
  property_map result;
...
std::string
GetProgramResourceName(const gl::GLuint program, const interface_type interface, const gl::GLuint index, const gl::GLint bufSize) {
...
std::vector<gl::GLint>
GetProgramResourceiv_vector(const gl::GLuint program, const interface_type interface, const gl::GLuint index, const gl::GLenum props,
  ...
  glGetProgramResourceiv(program, static_cast<gl::GLenum>(interface), index, propCount, &props, bufSize, &length, &params[0]);
  return params;
}
