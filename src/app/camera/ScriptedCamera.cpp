...
namespace viscom {
     ...
     */
    ScriptedCamera::ScriptedCamera(const glm::vec3& theCamPos, viscom::CameraHelper& cameraHelper, ApplicationNodeImplementation* appImpl) noexcept :
     ...
     */
    void ScriptedCamera::UpdateCamera(double elapsedTime, const ApplicationNodeBase* sender)
    {
