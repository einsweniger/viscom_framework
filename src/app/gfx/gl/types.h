...
enum type {
  ...
  atomic_counter_buffer =
      static_cast<unsigned int>(gl::GL_ATOMIC_COUNTER_BUFFER),
  ...
  transform_feedback_varying =
      static_cast<unsigned int>(gl::GL_TRANSFORM_FEEDBACK_VARYING),
  transform_feedback_buffer =
      static_cast<unsigned int>(gl::GL_TRANSFORM_FEEDBACK_BUFFER),
  ...
  vertex_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_VERTEX_SUBROUTINE_UNIFORM),
  tess_control_subroutine =
      static_cast<unsigned int>(gl::GL_TESS_CONTROL_SUBROUTINE),
  tess_control_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_TESS_CONTROL_SUBROUTINE_UNIFORM),
  tess_evaluation_subroutine =
      static_cast<unsigned int>(gl::GL_TESS_EVALUATION_SUBROUTINE),
  tess_evaluation_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_TESS_EVALUATION_SUBROUTINE_UNIFORM),
  geometry_subroutine = static_cast<unsigned int>(gl::GL_GEOMETRY_SUBROUTINE),
  geometry_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_GEOMETRY_SUBROUTINE_UNIFORM),
  fragment_subroutine = static_cast<unsigned int>(gl::GL_FRAGMENT_SUBROUTINE),
  fragment_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_FRAGMENT_SUBROUTINE_UNIFORM),
  compute_subroutine = static_cast<unsigned int>(gl::GL_COMPUTE_SUBROUTINE),
  compute_subroutine_uniform =
      static_cast<unsigned int>(gl::GL_COMPUTE_SUBROUTINE_UNIFORM),
};
...
valid for BUFFER_VARIABLE, PROGRAM_INPUT, PROGRAM_OUTPUT,
TRANSFORM_FEEDBACK_VARYING and UNIFORM
*/
enum class resource_type {
  ...
  glsl_samplerCubeArray =
      static_cast<unsigned int>(gl::GL_SAMPLER_CUBE_MAP_ARRAY),
  glsl_sampler1DArrayShadow =
      static_cast<unsigned int>(gl::GL_SAMPLER_1D_ARRAY_SHADOW),
  glsl_sampler2DArrayShadow =
      static_cast<unsigned int>(gl::GL_SAMPLER_2D_ARRAY_SHADOW),
  glsl_sampler2DMS = static_cast<unsigned int>(gl::GL_SAMPLER_2D_MULTISAMPLE),
  glsl_sampler2DMSArray =
      static_cast<unsigned int>(gl::GL_SAMPLER_2D_MULTISAMPLE_ARRAY),
  glsl_samplerCubeShadow =
      static_cast<unsigned int>(gl::GL_SAMPLER_CUBE_SHADOW),
  glsl_samplerCubeArrayShadow =
      static_cast<unsigned int>(gl::GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW),
  ...
  glsl_sampler2DRectShadow =
      static_cast<unsigned int>(gl::GL_SAMPLER_2D_RECT_SHADOW),
  ...
  glsl_isamplerCubeArray =
      static_cast<unsigned int>(gl::GL_INT_SAMPLER_CUBE_MAP_ARRAY),
  glsl_isampler2DMS =
      static_cast<unsigned int>(gl::GL_INT_SAMPLER_2D_MULTISAMPLE),
  glsl_isampler2DMSArray =
      static_cast<unsigned int>(gl::GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY),
  ...
  glsl_usamplerCube =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_CUBE),
  glsl_usampler1DArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_1D_ARRAY),
  glsl_usampler2DArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_2D_ARRAY),
  glsl_usamplerCubeArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY),
  glsl_usampler2DMS =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE),
  glsl_usampler2DMSArray = static_cast<unsigned int>(
      gl::GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY),
  glsl_usamplerBuffer =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_BUFFER),
  glsl_usampler2DRect =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_SAMPLER_2D_RECT),
  ...
  glsl_image2DMSArray =
      static_cast<unsigned int>(gl::GL_IMAGE_2D_MULTISAMPLE_ARRAY),
  ...
  glsl_iimageCubeArray =
      static_cast<unsigned int>(gl::GL_INT_IMAGE_CUBE_MAP_ARRAY),
  glsl_iimage2DMS = static_cast<unsigned int>(gl::GL_INT_IMAGE_2D_MULTISAMPLE),
  glsl_iimage2DMSArray =
      static_cast<unsigned int>(gl::GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY),
  ...
  glsl_uimage2DRect =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_2D_RECT),
  glsl_uimageCube = static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_CUBE),
  glsl_uimageBuffer =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_BUFFER),
  glsl_uimage1DArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_1D_ARRAY),
  glsl_uimage2DArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_2D_ARRAY),
  glsl_uimageCubeArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY),
  glsl_uimage2DMS =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE),
  glsl_uimage2DMSArray =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY),
  glsl_atomic_uint =
      static_cast<unsigned int>(gl::GL_UNSIGNED_INT_ATOMIC_COUNTER),
};
...
constexpr resource_type toType(gl::GLint type) {
  return static_cast<resource_type>(type);
}
