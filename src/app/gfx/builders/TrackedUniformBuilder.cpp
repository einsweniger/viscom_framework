...
std::unique_ptr<generic_uniform> TrackedUniformBuilder::operator()(
    named_resource res) {
...
TrackedUniform::TrackedUniform(named_resource res,
...
TrackVecFloat::TrackVecFloat(named_resource res,
                             viscom::ApplicationNodeImplementation* appImpl)
