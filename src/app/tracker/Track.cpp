...
std::string Track::value_str(float value) { return std::to_string(value); }
...
std::string strTrack::value_str(std::string value) { return value; }
...
void strKey::nextInterpolation() { interp.type = interpolation_type::Step; }
...
void FloatVecTrack::draw_value_edit(FloatVecKey &key) {
  switch (key.value.size()) {
    case 1:
      ImGui::DragFloat("##value", &key.value[0]);
      break;
    case 2:
      ImGui::DragFloat2("##value", &key.value[0]);
      break;
    case 3:
      ImGui::DragFloat3("##value", &key.value[0]);
      break;
    case 4:
      ImGui::DragFloat4("##value", &key.value[0]);
      break;
    default:
      ImGui::DragFloat("##value", &key.value[0]);
      break;
...
std::string draw_InputFloat3::as_string() { return "InputFloat3"; }

std::string draw_ColorEdit3::as_string() { return "ColorEdit3"; }
